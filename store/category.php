<?php
    if(!isset($_GET['id']) || isset($_GET['id']) && $_GET['id'] == ""){
        ...
        $categoryID = $_GET['id'];  
        $sql = "SELECT ID, `name`, icon, DevID, price,(SELECT AVG(rate) FROM rating_app WHERE rating_app.ID_app = `application`.ID) AS rate  FROM `application` WHERE category = ".$categoryID." AND `status` = 'approved'";
...
<div id="ranking" class="container mt-5 mb-5">
    <h3><b>Thể loại: <?php echo $rowCategory['name']?></b></h3>
    <hr>
    <div class="row">
    <?php
        ...
        <div class="col-6 col-sm-6 col-md-4 col-lg-2">
          <div class="card card-app p-2 shadow">
              ...
              <div class="mt-2">
                ...
                ?>
                <p class="card-publisher"><a href="index.php?navstore=developer&id=<?php echo $rowApp['DevID']?>" style="color: black;"><?php echo $rowDeveloper["name"]?></a></p>
